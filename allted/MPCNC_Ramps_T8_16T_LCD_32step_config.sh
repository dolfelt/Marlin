...
opt_enable SHOW_CUSTOM_BOOTSCREEN S_CURVE_ACCELERATION SDSUPPORT REVERSE_ENCODER_DIRECTION REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER ADAPTIVE_STEP_SMOOTHING CNC_COORDINATE_SYSTEMS GCODE_MOTION_MODES CUSTOM_USER_MENUS
opt_disable MIN_SOFTWARE_ENDSTOPS MAX_SOFTWARE_ENDSTOPS ST7920_DELAY_1 EVENT_GCODE_SD_STOP USER_DESC_4 USER_GCODE_4 USER_DESC_5 USER_GCODE_5
