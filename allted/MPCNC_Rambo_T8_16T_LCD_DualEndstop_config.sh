...
opt_enable SHOW_CUSTOM_BOOTSCREEN USE_XMAX_PLUG USE_YMAX_PLUG USE_ZMAX_PLUG S_CURVE_ACCELERATION SDSUPPORT REVERSE_ENCODER_DIRECTION REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER X_DUAL_STEPPER_DRIVERS X_DUAL_ENDSTOPS Y_DUAL_STEPPER_DRIVERS Y_DUAL_ENDSTOPS ADAPTIVE_STEP_SMOOTHING CNC_COORDINATE_SYSTEMS GCODE_MOTION_MODES CUSTOM_USER_MENUS
opt_disable MIN_SOFTWARE_ENDSTOP_Z MAX_SOFTWARE_ENDSTOPS EVENT_GCODE_SD_STOP USER_DESC_4 USER_GCODE_4 USER_DESC_5 USER_GCODE_5
